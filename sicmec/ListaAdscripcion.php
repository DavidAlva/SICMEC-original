...
<title>Datos Generales de Plazas</title>
</head>
<body>
<div id="header">
...
<div class="page-container">
	...
	<div class="main">
		<div class="main-content">
			<h1 class="pagetitle">Datos Generales de Plazas Comunitarias y Coordinaciones de Zona</h1>
  ...
  <table>
    ...
    <?php $par = 1; do {  ?>
      <tr <?php if($par == 2){ $par = 1; echo "class='alt'";}else $par = 2; ?> >
        <td nowrap="nowrap"><?php echo $row_Recordset1['CveAdscrip']; ?></td>
        ...
        <td><?php echo $row_Recordset1['CodPostal']; ?></td>
