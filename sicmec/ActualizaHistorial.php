...
/*QUERY QUE BUSCA EL ACTIVO DE ACUERDO A LOS FILTROS*/
  mysql_select_db($database_SICMEC, $SICMEC);
$query_Recordset9 = sprintf("SELECT NumInv, CveCatalogo, AnnoAlta, NumSerie, Diagnostico FROM historialstatus WHERE CveCatalogo = '%s' AND NumInv = %s AND AnnoAlta = %s AND NumSerie = '%s' ORDER BY FecHist Desc" , $CveCatalogo, $NumInv, $AnnoAlta, $NumSerie);
...
<div class="page-container">
	<div class="header-breadcrumbs">
		<ul>
			...
			<li><a href="#">Actualiza Historial</a></li>
		</ul>
		<!-- Cerrar Sesion -->
		<div class="boton">
	...
	<div class="main">
		<div class="main-content">
			...
			<div class="column1-unit">
  			...
  			<form class="formulario" style="width:600px" action="HistorialStatus.php" method="POST" name="form1" id="form1" onSubmit="MM_validateForm('NumInv','','RisNum','Diagnostico','','R');return document.MM_returnValue" >
    			<p>
...
?>
        	...
        	<p>
        		<label for="Fecha" class="leftW">Fecha:</label>
          ...
          <input type="hidden" name="CveHist" value = "<?php $CveHist;?>"/>
